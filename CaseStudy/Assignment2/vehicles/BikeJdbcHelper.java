...
public class BikeJdbcHelper {
	...
	// creates bike table
	public static String createBikeTable() throws VehicleManagementException {
		...
		try {
			...
			createdVehicleType = "Bike created";
	...
	// delete vehicle table. Since delete cascade is used so associated entries
	// from car and bike are also deleted
	public static String deleteBikeTable(int vehicleId)
			throws VehicleManagementException {
		String str = null;
		Connection con = null;
		Statement stmt = null;
		...
		String query = "SELECT vehicle_id FROM Bike WHERE vehicle_id = "
				+ vehicleId;
		try {
			stmt = con.createStatement();
