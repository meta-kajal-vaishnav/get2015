...
public class VehicleDBHelper {
    ...
    private static String INSERT_VEHICLE_QUERY = "INSERT INTO vehicle (make, model, engine_in_cc, fuel_capacity, milage, price, road_tax, created_by, created_time, image) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
