...
public class QuickSort 
{
	...
	public int[] quickSort ( int pivot, int end )  // initially pivot is = first element of array and end = arr.length
	{
		int storeIndex = pivot + 1;   // storeIndex contains pivot's next element
