...
public class SortingSystemTest {
	...
	public void testIfBubbleSortUsedPositive() {
		int arrInput[] = { 3, 2, 5, 6, 1 }, typeOfSorting = 1, sortType = 0; // for
																				// bubble
																				// sort
		SortingSystem objSortingSystem = new SortingSystem();
		sortType = objSortingSystem.selectSortType(arrInput, typeOfSorting,
				objSortingSystem, sortType);
	...
	public void testIfQuickSortUsedPositive() {
		int arrInput[] = { 3, 2, 5, 6, 1, 7, 9, 8, 0, 13, 1 }, typeOfSorting = 1, sortType = 0; // for
																								// quick
																								// sort
		SortingSystem objSortingSystem = new SortingSystem();
		sortType = objSortingSystem.selectSortType(arrInput, typeOfSorting,
	...
	public void testIfCountingSortUsedPositive() {
		int arrInput[] = { 3, 2, 5, 6, 1 }, typeOfSorting = 2, sortType = 0; // for
																				// counting
																				// sort
		SortingSystem objSortingSystem = new SortingSystem();
		sortType = objSortingSystem.selectSortType(arrInput, typeOfSorting,
	...
	public void testIfRadixSortUsedPositive() {
		int arrInput[] = { 232, 112, 456 }, typeOfSorting = 2, sortType = 0; // for
																				// radix
																				// sort
		SortingSystem objSortingSystem = new SortingSystem();
		sortType = objSortingSystem.selectSortType(arrInput, typeOfSorting,
