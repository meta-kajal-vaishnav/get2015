			...
			while (true)
			{
				...
				switch (choice)
				{
					...
					case 2 : do
							 ...
							 sortType = objSortingSystem.selectSortType ( arrNumbers, typeOfSorting, objSortingSystem, sortType );
					 		 break;
					
					case 3 : System.out.println ( objSortingSystem.printSortType(sortType) );
