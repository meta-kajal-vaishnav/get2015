...
{	
	public int selectSortType ( int arrNumbers[], int typeOfSorting, SortingSystem objSortingSystem, int sortType )
	{
		switch ( typeOfSorting )
		 {
		 	case 1 : if ( arrNumbers.length <= 10 )  // call bubble sort
		 			 {
		 			 	 sortType = 1;
		 	...
		 	case 2 : int largestValue = arrNumbers[0];
